  ...
  <div v-loading="qLoading" style="line-height:1.8">
    <div v-if="qType==1||qType==2||qType==3||qType==4||qType==5">
      ...
      <div v-else-if="qType==3">
        <div class="q-title" style="display: inline;margin-right: 10px" v-html="question.questionObject.titleContent" />
      ...
      <div v-else-if="qType==4">
        ...
        <div v-if="answer.contentArray!==null">
          <el-form-item v-for="item in question.questionObject.questionItemObjects" :key="item.prefix" :label="item.prefix" label-width="50px" style="margin-top: 10px;margin-bottom: 10px;">
      ...
      <div class="question-answer-show-item" style="line-height: 1.8">
        ...
        <span class="q-item-span-content" v-html="question.questionObject.analyze" />
      </div>
      <div class="question-answer-show-item">
        <span class="question-show-item">正确答案：</span>
        <span v-if="qType==1||qType==2 ||qType==5" class="q-item-span-content" v-html="question.questionObject.correct" />
...
export default {
  ...
  created() {
    ...
    this.doRightEnumMap = store.state.enumItem.exam.question.answer.doRightEnum
  },
  ...
  methods: {
    ...
    doRightTextFormatter(status) {
      return this.doRightEnumMap.get(status)
    }
  }
