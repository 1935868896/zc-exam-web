  ...
  <div class="app-container">
    <el-form ref="form" v-loading="formLoading" :model="form" label-width="100px" :rules="rules">
      ...
      <el-form-item label="选项：" required>
        <el-form-item v-for="(item) in form.questionObject.questionItemObjects" :key="item.prefix" :label="item.prefix" label-width="50px" class="question-item-label">
          <el-input v-model="item.prefix" style="width:50px;" />
          <el-input v-model="item.content" style="  margin-left: 8px; width: 60%;" class="question-item-content-input" @focus="inputClick(item,'content')" />
        </el-form-item>
      </el-form-item>
      ...
      <el-form-item label="正确答案：" prop="correct" required>
        <el-radio-group v-model="form.correct">
          <el-radio v-for="item in form.questionObject.questionItemObjects" :key="item.prefix" :label="item.prefix">{{ item.prefix }}</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item>
    ...
    return {
      form: {
        ...
        questionObject: {
          titleContent: '',
          analyze: '',
          questionItemObjects: [{ id: null, prefix: 'A', content: '是' },
